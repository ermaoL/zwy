...
myApp.controller('mainCtrl', ['$scope', '$state', '$http', function ($scope, $state, $http) {
    ...
    $http.get('/trans/api/queryContainerType', {
    ...
    $http({
        url:'/trans/api/queryContainerSize',
        method:'GET',
        headers: {"userName": $.cookie("userName"), "token": $.cookie("token")}
    }).success(function (data) {
        if (data.success) {
    ...
    if (url == "#/main/import/detail") {
        changeMenuType('#import-detail-menu');
        sessionStorage.setItem("menuStatus", 2);
    } else if (url == "#/main/export/list") {
        changeMenuType('#export-list-menu');
        sessionStorage.setItem("menuStatus", 3);
    } else if (url == "#/main/export/detail") {
        changeMenuType('#export-detail-menu');
        sessionStorage.setItem("menuStatus", 4);
    } else if (url == "#/main/ticket/follow" || url == "#/main/single/ticket/follow") {
    ...
    } else if (url == "#/main/transit/order") {
        changeMenuType('#transit-order-menu');
        sessionStorage.setItem("menuStatus", 6);
    } else if (url == "#/main/bill/inquiry") {
        changeMenuType('#bill-inquiry-menu');
        sessionStorage.setItem("menuStatus", 7);
    } else if (url == "#/main/user/manage") {
    ...
    $scope.sendChangePwd = function() {
        ...
        if($scope.changePwdForm.$valid) {
            ...
            var requestData = {"oldPass": $scope.oldPwd, "newPass": $scope.newPwd};

            $http.post("/trans/api/user/pass/changes", requestData, {
                headers: {
